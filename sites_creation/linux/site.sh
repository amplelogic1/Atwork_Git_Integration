...
./clientcreations.sh --path "$base_path/Design_Client/" --port "$port_design_client" --name "$project_code"
./clientcreations.sh --path "$base_path/Run_Client/" --port "$port_run_client" --name "$project_code"
./sitescreations.sh --path "$base_path/Design_Server" --port "$port_design_server" --name "$project_code"
